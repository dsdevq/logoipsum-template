		...
		<div className='container'>
			<section className='flex items-center justify-between gap-2 sm:flex-wrap-reverse'>
				...
				<aside className='basis-7/12 flex flex-col gap-9 shrink-0  sm:flex-1'>
					...
					<form action='submit' className='flex gap-10'>
						<input
							...
							placeholder='Email'
						/>
						<button className='transition-all active:scale-[1.015] text-[17px] font-bold leading-6 text-center py-[19px] px-[60px] rounded-[10px] bg-purple text-white min-w-max sm:px-7 flex-1 sm:max-w-none'>
							Try
						</button>
					</form>
				</aside>
